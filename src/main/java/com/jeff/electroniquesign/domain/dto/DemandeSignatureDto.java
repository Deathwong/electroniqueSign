...
public record DemandeSignatureDto(Long id, @NotBlank @Size(max = 20, min = 5) String statut,
                                  @NotNull @PastOrPresent Instant dateDemande, @NotNull
                                  @FutureOrPresent LocalDate dateExpiration,
                                  @NotNull Utilisateur utilisateur, @NotNull Signataire signataire,
